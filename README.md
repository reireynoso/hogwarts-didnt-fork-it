...
<!-- * create an index displaying all hog tiles (Container Component) -->
<!-- * render each hog name and picture in a tile (Card Component) -->
<!-- * show the hog's details upon a user's click (Card Component but w/ event) -->
<!-- * filter the hogs that are greased (Filter Component) -->
<!-- * sort the hogs based on name (Sort Name Component) -->
* sort the hogs based on weight (Sort Weight Component)
